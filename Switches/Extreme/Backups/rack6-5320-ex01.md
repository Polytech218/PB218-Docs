# Notes
- Based off of [5320 Template](../Templates/5320.md)
- Original: [rack6-5320-ex01.xsf](rack6-5320-ex01.xsf)
- Config: [rack6-5320-ex01.cfg](rack6-5320-ex01.cfg)
- Generated via `save config as-script "rack6-5320-ex01"`
- Backed up via `scp admin@rack6-5320-ex01.pb218.lab:rack6-5320-ex01.xsf .`
# Configuration
```
#  
# Module devmgr configuration.  
#  
configure snmp sysName "rack6-5320-ex01"  
configure snmp sysLocation "PB210 - Rack 6"  
...
configure vlan Net-MGMT ipaddress 10.10.1.1 255.255.255.0  
...
#  
configure stpd s0 add vlan Access ports 1-32 dot1d  
