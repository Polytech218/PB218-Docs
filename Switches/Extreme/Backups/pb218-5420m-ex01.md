...
- Original: [pb218-5420m-ex01.xsf](pb218-5420m-ex01.xsf)
- Config: [pb218-5420m-ex01.cfg](pb218-5420m-ex01.cfg)
- Generated with `save config as-script "pb218-5420m-ex01"`
- Backed up via `scp admin@pb218-5420m-ex01.pb218.lab:pb218-5420m-ex01.xsf .`
# Configuration
```
#
# Module devmgr configuration.
#
configure snmp sysName "pb218-5420m-ex01"
...
configure vlan Net-MGMT add ports 1-48 tagged  
configure vlan Net-MGMT add ports 49-56 untagged  
configure vlan Servers add ports 1-56 tagged  
configure vlan Net-MGMT ipaddress 10.10.1.8 255.255.255.0
...
#
configure stpd s0 add vlan Access ports 1-48 dot1d
configure stpd s0 add vlan Net-MGMT ports 1-56 dot1d
configure stpd s0 add vlan Servers ports 1-56 dot1d
