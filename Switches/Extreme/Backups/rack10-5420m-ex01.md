# Notes
- Based off of [5420M Template](../Templates/5420M.md)
- Original: [rack10-5420m-ex01.xsf](rack10-5420m-ex01.xsf)
- Config: [rack10-5420m-ex01.cfg](rack10-5420m-ex01.cfg)
- Generated with `save config as-script "rack10-5420m-ex01"`
- Backed up via `scp admin@rack10-5420m-ex01.pb218.lab:rack10-5420m-ex01.xsf .`
# Configuration
```
#  
...
#  
configure stpd s0 add vlan Access ports 2-32,49-56 dot1d  
configure stpd s0 add vlan Cluster-MGMT ports 2-32,49-56 dot1d  
configure stpd s0 add vlan Firewall-HA ports 20,23-28,31-32,49-56 dot1d  
configure stpd s0 add vlan Net-MGMT ports 2-32,49-56 dot1d  
configure stpd s0 add vlan Servers ports 2-32,49-56 dot1d  
